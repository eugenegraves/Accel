...
export function HomePage() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-4 border-b border-zinc-800 safe-area-inset-top">
        <h1 className="text-2xl font-bold text-zinc-100">Accel</h1>
        <button
          type="button"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 safe-area-inset-bottom">
        ...
        <div className="grid grid-cols-4 gap-3 mb-8">
          ...
          >
            ...
            <span className="text-sm font-medium text-zinc-200">Sprint</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-zinc-200">Lift</span>
          </button>
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <button
            ...
            className="flex flex-col items-center gap-1.5 p-3 bg-zinc-900/50 border border-zinc-700 rounded-lg hover:bg-zinc-800 transition-colors duration-150"
          >
            <svg className="w-5 h-5 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span className="text-xs font-medium text-zinc-300">Review</span>
          </button>
        ...
        <section className="mb-6">
          <h2 className="text-sm font-medium text-zinc-400 mb-3">RECENT SPRINTS</h2>
          {sprintsLoading ? (
            ...
            <p className="text-zinc-600 text-sm">No sprint sessions yet</p>
          )}
        </section>

        {/* Recent Lift Sessions */}
        <section className="mb-6">
          <h2 className="text-sm font-medium text-zinc-400 mb-3">RECENT LIFTS</h2>
          {liftsLoading ? (
            <p className="text-zinc-600 text-sm">Loading...</p>
            ...
            <p className="text-zinc-600 text-sm">No lift sessions yet</p>
          )}
        </section>

        {/* Recent Meets */}
        <section className="mb-6">
          <h2 className="text-sm font-medium text-zinc-400 mb-3">RECENT MEETS</h2>
          {meetsLoading ? (
            <p className="text-zinc-600 text-sm">Loading...</p>
            ...
            <div className="space-y-2">
              {recentMeets.map((meet) => (
                ...
                >
                  <div className="flex-1 text-left">
                    <p className="font-medium text-zinc-200">{meet.name}</p>
